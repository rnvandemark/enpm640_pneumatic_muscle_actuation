...
#include "pma_interfaces/msg/labelled_joint_trajectory.hpp"
#include "pma_interfaces/msg/labelled_pma_robot_trajectory_point.hpp"
...
protected:
    ...
    using JointTrajectoryPtMsg = trajectory_msgs::msg::JointTrajectoryPoint;
...
protected:
    ...
    JointTrajectoryPtMsg joint_space_state_current_;
    JointTrajectoryPtMsg joint_space_state_desired_;
    JointTrajectoryPtMsg joint_space_state_error_;

    /**
     * The number identifier of the current motion, this is incremented for
     * each accepted and executed motion, with the first motion number being 0.
     */
    int motion_number;
    /**
     * The data relevant to the last commanded pressure, including the joint
     * positions, velocities, accelerations, efforts, and pressures.
     */
    pma_interfaces::msg::PmaRobotTrajectoryPoint last_commanded_pma_traj_pt_;
    /**
     * The publisher for simple executed trajectory telemetry, corresponding to
     * @a motion_number.
     */
    rclcpp::Publisher<pma_interfaces::msg::LabelledJointTrajectory>::SharedPtr labelled_joint_trajectory_publisher_;
    /**
     * The publisher for each commanded combined joint space and pressure
     * trajectory point, corresponding to @a motion_number.
     */
    rclcpp::Publisher<pma_interfaces::msg::LabelledPmaRobotTrajectoryPoint>::SharedPtr labelled_pma_robot_trajectory_publisher_;
    ...
    void read_state_from_hardware(JointTrajectoryPtMsg& state);

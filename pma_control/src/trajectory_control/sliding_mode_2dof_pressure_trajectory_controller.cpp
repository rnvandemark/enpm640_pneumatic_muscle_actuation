#include "pma_control/trajectory_control/sliding_mode_2dof_pressure_trajectory_controller.hpp"
...
const static pma_hardware::PneumaticMuscleSegmentConfiguration DEFAULT_SHOULDER_SEGMENT_CONFIGURATION(
    /*mass = */ 10.0,
    /*pulley_radius = */ 0.0762,
    /*segment_length = */ 0.46,
    /*segment_com_length = */ 0.23,
    /*pm_antagonist_pair_count = */ 6,
    /*bicep__nominal_pressure = */ 310.3,
    /*bicep__dynamics_f_0 = */ 179.2,
    /*bicep__dynamics_f_1 = */ 1.39,
    /*bicep__dynamics_k_0 = */ 5.71,
    /*bicep__dynamics_k_1 = */ 0.0307,
    /*bicep__dynamics_b_0_inflating = */ 1.01,
    /*bicep__dynamics_b_1_inflating = */ 0.00691,
    /*bicep__dynamics_b_0_deflating = */ 0.6,
    /*bicep__dynamics_b_1_deflating = */ 0.000803,
    /*tricep__nominal_pressure = */ 449.6,
    /*tricep__dynamics_f_0 = */ 179.2,
    /*tricep__dynamics_f_1 = */ 1.39,
    /*tricep__dynamics_k_0 = */ 5.71,
    /*tricep__dynamics_k_1 = */ 0.0307,
    /*tricep__dynamics_b_0_inflating = */ 1.01,
    /*tricep__dynamics_b_1_inflating = */ 0.00691,
    /*tricep__dynamics_b_0_deflating = */ 0.6,
    /*tricep__dynamics_b_1_deflating = */ 0.000803
);
const static pma_hardware::PneumaticMuscleSegmentConfiguration DEFAULT_ELBOW_SEGMENT_CONFIGURATION(
    /*mass = */ 10.0,
    /*pulley_radius = */ 0.0508,
    /*segment_length = */ 0.46,
    /*segment_com_length = */ 0.23,
    /*pm_antagonist_pair_count = */ 3,
    /*bicep__nominal_pressure = */ 310.5,
    /*bicep__dynamics_f_0 = */ 179.2,
    /*bicep__dynamics_f_1 = */ 1.39,
    /*bicep__dynamics_k_0 = */ 5.71,
    /*bicep__dynamics_k_1 = */ 0.0307,
    ...
    /*bicep__dynamics_b_0_deflating = */ 0.6,
    /*bicep__dynamics_b_1_deflating = */ 0.000803,
    /*tricep__nominal_pressure = */ 310.3,
    /*tricep__dynamics_f_0 = */ 179.2,
    /*tricep__dynamics_f_1 = */ 1.39,
    /*tricep__dynamics_k_0 = */ 5.71,
    /*tricep__dynamics_k_1 = */ 0.0307,
...
namespace
{
    ...
    void compute_pma_robot_model(
        ...
        std::vector<double>& desired_joint_accelerations,
        std::shared_ptr<rclcpp_lifecycle::LifecycleNode> node = nullptr
    )
    {
#define CONDITIONAL_LOG(level, ...) if (node) RCLCPP_##level(node->get_logger(), __VA_ARGS__);
...
#undef DECLARE_SEGMENT_VARS
        ...
        CONDITIONAL_LOG(
            INFO,
            "- shoulder={m=%.2lf, l=%.2lf, lc=%.2lf, I=%.2lf}, elbow={m=%.2lf, l=%.2lf, lc=%.2lf, I=%.2lf}",
            m_1, l_1, l_com_1, I_1, m_2, l_2, l_com_2, I_2
        );
...
#undef DECLARE_JOINT_VARS
        ...
        CONDITIONAL_LOG(
            INFO,
            "- act_pos[0]=%.2lf, act_vel[1]=%.2lf, act_pos[2]=%.2lf, act_vel[3]=%.2lf, des_pos[0]=%.2lf, des_vel[1]=%.2lf, des_pos[2]=%.2lf, des_vel[3]=%.2lf",
            th_star_1, th_dot_star_1, th_1, th_dot_1, th_star_2, th_dot_star_2, th_2, th_dot_2
        );
        ...
        CONDITIONAL_LOG(
            INFO,
            "- tau_0_s=%.2lf, tau_1_s=%.2lf, tau_0_e=%.2lf, tau_1_e=%.2lf",
            shoulder_torque_nominal_pressure, shoulder_torque_factor_input_pressure, elbow_torque_nominal_pressure, elbow_torque_factor_input_pressure
        );

        //
        // Use the exact equations as presented in the article. These are NOT
        // used other than comparing them here and logging values if they
        // disagree.
        //

        const double B_0_b_s = shoulder_segment_telemetry.bicep_telemetry.is_inflating() ? shoulder_segment_configuration.bicep_configuration.dynamics_B_0_inflating : shoulder_segment_configuration.bicep_configuration.dynamics_B_0_deflating;
        const double B_1_b_s = shoulder_segment_telemetry.bicep_telemetry.is_inflating() ? shoulder_segment_configuration.bicep_configuration.dynamics_B_1_inflating : shoulder_segment_configuration.bicep_configuration.dynamics_B_1_deflating;
        const double B_0_t_s = shoulder_segment_telemetry.tricep_telemetry.is_inflating() ? shoulder_segment_configuration.tricep_configuration.dynamics_B_0_inflating : shoulder_segment_configuration.tricep_configuration.dynamics_B_0_deflating;
        const double B_1_t_s = shoulder_segment_telemetry.tricep_telemetry.is_inflating() ? shoulder_segment_configuration.tricep_configuration.dynamics_B_1_inflating : shoulder_segment_configuration.tricep_configuration.dynamics_B_1_deflating;
        const double alt_tau_0_s = shoulder_segment_configuration.pulley_radius * shoulder_segment_configuration.pm_antagonist_pair_count * (
            shoulder_segment_configuration.tricep_configuration.dynamics_F_0
            + (shoulder_segment_configuration.tricep_configuration.nominal_pressure * shoulder_segment_configuration.tricep_configuration.dynamics_F_1)
            - (shoulder_segment_telemetry.tricep_telemetry.length * (shoulder_segment_configuration.tricep_configuration.dynamics_K_0 + (shoulder_segment_configuration.tricep_configuration.nominal_pressure * shoulder_segment_configuration.tricep_configuration.dynamics_K_1)))
            - (shoulder_segment_telemetry.tricep_telemetry.lengthening_rate * (B_0_t_s + (shoulder_segment_configuration.tricep_configuration.nominal_pressure * B_1_t_s)))
            - shoulder_segment_configuration.bicep_configuration.dynamics_F_0
            - (shoulder_segment_configuration.bicep_configuration.nominal_pressure * shoulder_segment_configuration.bicep_configuration.dynamics_F_1)
            + (shoulder_segment_telemetry.bicep_telemetry.length * (shoulder_segment_configuration.bicep_configuration.dynamics_K_0 + (shoulder_segment_configuration.bicep_configuration.nominal_pressure * shoulder_segment_configuration.bicep_configuration.dynamics_K_1)))
            + (shoulder_segment_telemetry.bicep_telemetry.lengthening_rate * (B_0_b_s + (shoulder_segment_configuration.bicep_configuration.nominal_pressure * B_1_b_s)))
        );
        const double alt_tau_1_s = shoulder_segment_configuration.pulley_radius * shoulder_segment_configuration.pm_antagonist_pair_count * (
            -shoulder_segment_configuration.tricep_configuration.dynamics_F_1
            + (shoulder_segment_telemetry.tricep_telemetry.length * shoulder_segment_configuration.tricep_configuration.dynamics_K_1)
            - (shoulder_segment_telemetry.tricep_telemetry.lengthening_rate * B_1_t_s)
            - shoulder_segment_configuration.bicep_configuration.dynamics_F_1
            + (shoulder_segment_telemetry.bicep_telemetry.length * shoulder_segment_configuration.bicep_configuration.dynamics_K_1)
            + (shoulder_segment_telemetry.bicep_telemetry.lengthening_rate * B_1_b_s)
        );
        const double B_0_b_e = elbow_segment_telemetry.bicep_telemetry.is_inflating() ? elbow_segment_configuration.bicep_configuration.dynamics_B_0_inflating : elbow_segment_configuration.bicep_configuration.dynamics_B_0_deflating;
        const double B_1_b_e = elbow_segment_telemetry.bicep_telemetry.is_inflating() ? elbow_segment_configuration.bicep_configuration.dynamics_B_1_inflating : elbow_segment_configuration.bicep_configuration.dynamics_B_1_deflating;
        const double B_0_t_e = elbow_segment_telemetry.tricep_telemetry.is_inflating() ? elbow_segment_configuration.tricep_configuration.dynamics_B_0_inflating : elbow_segment_configuration.tricep_configuration.dynamics_B_0_deflating;
        const double B_1_t_e = elbow_segment_telemetry.tricep_telemetry.is_inflating() ? elbow_segment_configuration.tricep_configuration.dynamics_B_1_inflating : elbow_segment_configuration.tricep_configuration.dynamics_B_1_deflating;
        const double alt_tau_0_e = elbow_segment_configuration.pulley_radius * elbow_segment_configuration.pm_antagonist_pair_count * (
            elbow_segment_configuration.bicep_configuration.dynamics_F_0
            + (elbow_segment_configuration.bicep_configuration.nominal_pressure * elbow_segment_configuration.bicep_configuration.dynamics_F_1)
            - (elbow_segment_telemetry.bicep_telemetry.length * (elbow_segment_configuration.bicep_configuration.dynamics_K_0 + (elbow_segment_configuration.bicep_configuration.nominal_pressure * elbow_segment_configuration.bicep_configuration.dynamics_K_1)))
            - (elbow_segment_telemetry.bicep_telemetry.lengthening_rate * (B_0_b_e + (elbow_segment_configuration.bicep_configuration.nominal_pressure * B_1_b_e)))
            - elbow_segment_configuration.tricep_configuration.dynamics_F_0
            - (elbow_segment_configuration.tricep_configuration.nominal_pressure * elbow_segment_configuration.tricep_configuration.dynamics_F_1)
            + (elbow_segment_telemetry.tricep_telemetry.length * (elbow_segment_configuration.tricep_configuration.dynamics_K_0 + (elbow_segment_configuration.tricep_configuration.nominal_pressure * elbow_segment_configuration.tricep_configuration.dynamics_K_1)))
            + (elbow_segment_telemetry.tricep_telemetry.lengthening_rate * (B_0_t_e + (elbow_segment_configuration.tricep_configuration.nominal_pressure * B_1_t_e)))
        );
        const double alt_tau_1_e = elbow_segment_configuration.pulley_radius * elbow_segment_configuration.pm_antagonist_pair_count * (
            elbow_segment_configuration.bicep_configuration.dynamics_F_1
            + (elbow_segment_telemetry.bicep_telemetry.length * elbow_segment_configuration.bicep_configuration.dynamics_K_1)
            - (elbow_segment_telemetry.bicep_telemetry.lengthening_rate * B_1_b_e)
            + elbow_segment_configuration.tricep_configuration.dynamics_F_1
            - (elbow_segment_telemetry.tricep_telemetry.length * elbow_segment_configuration.tricep_configuration.dynamics_K_1)
            + (elbow_segment_telemetry.tricep_telemetry.lengthening_rate * B_1_t_e)
        );

        if (shoulder_torque_nominal_pressure != alt_tau_0_s)
        {
            CONDITIONAL_LOG(
                WARN,
                "- tau_0_s (%.2lf) != alt_tau_0_s (%.2lf)",
                shoulder_torque_nominal_pressure, alt_tau_0_s
            );
        }
        if (shoulder_torque_factor_input_pressure != alt_tau_1_s)
        {
            CONDITIONAL_LOG(
                WARN,
                "- tau_1_s (%.2lf) != alt_tau_1_s (%.2lf)",
                shoulder_torque_factor_input_pressure, alt_tau_1_s
            );
        }
        if (elbow_torque_nominal_pressure != alt_tau_0_e)
        {
            CONDITIONAL_LOG(
                WARN,
                "- tau_0_e (%.2lf) != alt_tau_0_e (%.2lf)",
                elbow_torque_nominal_pressure, alt_tau_0_e
            );
        }
        if (elbow_torque_factor_input_pressure != alt_tau_1_e)
        {
            CONDITIONAL_LOG(
                WARN,
                "- tau_1_e (%.2lf) != alt_tau_1_e (%.2lf)",
                elbow_torque_factor_input_pressure, alt_tau_1_e
            );
        }

        // Calculate the inverse of the D matrix
        const double c_2 = std::cos(th_2);
        const double d11 = (2 * I_1) + (2 * I_2) + (m_2 * l_1 * (l_1 + (2 * l_com_2 * c_2)));
        ...
        CONDITIONAL_LOG(
            INFO,
            "- c_2=%.2lf, d11=%.2lf, d12=%.2lf, d22=%.2lf",
            c_2, d11, d12, d22
        );
        ...
        CONDITIONAL_LOG(
            INFO,
            "- G00=%.2lf, G01=%.2lf, G10=%.2lf, G11=%.2lf",
            model_G(0,0), model_G(0,1), model_G(1,0), model_G(1,1)
        );
        ...
        const Eigen::Vector2d sigma = th_dot - th_r;

        CONDITIONAL_LOG(
            INFO,
            "- th_r[0]=%.2lf, th_r[1]=%.2lf",
            th_r(0), th_r(1)
        );
        CONDITIONAL_LOG(
            INFO,
            "- sigma[0]=%.2lf, sigma[1]=%.2lf",
            sigma(0), sigma(1)
        );
        ...
        {{
            pm_control_configuration.k_1 * sat(sigma(0) / pm_control_configuration.Gamma_1),
            pm_control_configuration.k_2 * sat(sigma(1) / pm_control_configuration.Gamma_2)
        }};
        ...
        // Calculate the unrestricted resulting input pressures
        const Eigen::Matrix2d G_inv = model_G.inverse();
        Eigen::Vector2d delta_p = G_inv.hasNaN() ? Eigen::Vector2d{{0.0, 0.0}} : (G_inv * (th_r - model_a - ks));

        resulting_pressure_state = {delta_p(0), delta_p(1)};

        CONDITIONAL_LOG(
            INFO,
            "- Ginv00=%.2lf, Ginv01=%.2lf, Ginv10=%.2lf, Ginv11=%.2lf",
            G_inv(0,0), G_inv(0,1), G_inv(1,0), G_inv(1,1)
        );
        CONDITIONAL_LOG(
            INFO,
            "- dp[0]=%.2lf, dp[1]=%.2lf",
        ...
        // Calculate the resulting joint accelerations
        
        const Eigen::Vector2d th_ddot = model_a + (model_G * delta_p);
        desired_joint_accelerations = {th_ddot(0), th_ddot(1)};
...
#define AUTO_DEC_CONFIG_PARAM(param_name, param_type, value) const param_type param_name = auto_declare<param_type>(#param_name, value)
    ...
    try
    {
        ...
        pm_segment_configurations.emplace_back(
            shoulder_mass,
...
SlidingMode2DofPressureTrajectoryController::on_configure(const rclcpp_lifecycle::State& /*previous_state*/)
{
    ...
    {
#define UPDATE_CONFIG_PARAM(param_name, param_type) const param_type param_name = get_node()->get_parameter(#param_name).get_value<param_type>()

        // Parameters specific to sliding-mode control
        UPDATE_CONFIG_PARAM(acceleration_gravity, double);
        UPDATE_CONFIG_PARAM(sliding_mode_control_k_1, double);
        UPDATE_CONFIG_PARAM(sliding_mode_control_k_2, double);
        UPDATE_CONFIG_PARAM(sliding_mode_control_Gamma_1, double);
        UPDATE_CONFIG_PARAM(sliding_mode_control_Gamma_2, double);
        UPDATE_CONFIG_PARAM(sliding_mode_control_mu_1, double);
        UPDATE_CONFIG_PARAM(sliding_mode_control_mu_2, double);

        // Parameters specific to robot properties
        UPDATE_CONFIG_PARAM(shoulder_mass, double);
        UPDATE_CONFIG_PARAM(shoulder_pulley_radius, double);
        UPDATE_CONFIG_PARAM(shoulder_segment_length, double);
        UPDATE_CONFIG_PARAM(shoulder_segment_com_length, double);
        UPDATE_CONFIG_PARAM(shoulder_pm_antagonist_pair_count, int);
        UPDATE_CONFIG_PARAM(shoulder_bicep_nominal_pressure, double);
        UPDATE_CONFIG_PARAM(shoulder_bicep_dynamics_F_0, double);
        UPDATE_CONFIG_PARAM(shoulder_bicep_dynamics_F_1, double);
        UPDATE_CONFIG_PARAM(shoulder_bicep_dynamics_K_0, double);
        UPDATE_CONFIG_PARAM(shoulder_bicep_dynamics_K_1, double);
        UPDATE_CONFIG_PARAM(shoulder_bicep_dynamics_B_0_inflating, double);
        UPDATE_CONFIG_PARAM(shoulder_bicep_dynamics_B_1_inflating, double);
        UPDATE_CONFIG_PARAM(shoulder_bicep_dynamics_B_0_deflating, double);
        UPDATE_CONFIG_PARAM(shoulder_bicep_dynamics_B_1_deflating, double);
        UPDATE_CONFIG_PARAM(shoulder_tricep_nominal_pressure, double);
        UPDATE_CONFIG_PARAM(shoulder_tricep_dynamics_F_0, double);
        UPDATE_CONFIG_PARAM(shoulder_tricep_dynamics_F_1, double);
        UPDATE_CONFIG_PARAM(shoulder_tricep_dynamics_K_0, double);
        UPDATE_CONFIG_PARAM(shoulder_tricep_dynamics_K_1, double);
        UPDATE_CONFIG_PARAM(shoulder_tricep_dynamics_B_0_inflating, double);
        UPDATE_CONFIG_PARAM(shoulder_tricep_dynamics_B_1_inflating, double);
        UPDATE_CONFIG_PARAM(shoulder_tricep_dynamics_B_0_deflating, double);
        UPDATE_CONFIG_PARAM(shoulder_tricep_dynamics_B_1_deflating, double);
        UPDATE_CONFIG_PARAM(elbow_mass, double);
        UPDATE_CONFIG_PARAM(elbow_pulley_radius, double);
        UPDATE_CONFIG_PARAM(elbow_segment_length, double);
        UPDATE_CONFIG_PARAM(elbow_segment_com_length, double);
        UPDATE_CONFIG_PARAM(elbow_pm_antagonist_pair_count, int);
        UPDATE_CONFIG_PARAM(elbow_bicep_nominal_pressure, double);
        UPDATE_CONFIG_PARAM(elbow_bicep_dynamics_F_0, double);
        UPDATE_CONFIG_PARAM(elbow_bicep_dynamics_F_1, double);
        UPDATE_CONFIG_PARAM(elbow_bicep_dynamics_K_0, double);
        UPDATE_CONFIG_PARAM(elbow_bicep_dynamics_K_1, double);
        UPDATE_CONFIG_PARAM(elbow_bicep_dynamics_B_0_inflating, double);
        UPDATE_CONFIG_PARAM(elbow_bicep_dynamics_B_1_inflating, double);
        UPDATE_CONFIG_PARAM(elbow_bicep_dynamics_B_0_deflating, double);
        UPDATE_CONFIG_PARAM(elbow_bicep_dynamics_B_1_deflating, double);
        UPDATE_CONFIG_PARAM(elbow_tricep_nominal_pressure, double);
        UPDATE_CONFIG_PARAM(elbow_tricep_dynamics_F_0, double);
        UPDATE_CONFIG_PARAM(elbow_tricep_dynamics_F_1, double);
        UPDATE_CONFIG_PARAM(elbow_tricep_dynamics_K_0, double);
        UPDATE_CONFIG_PARAM(elbow_tricep_dynamics_K_1, double);
        UPDATE_CONFIG_PARAM(elbow_tricep_dynamics_B_0_inflating, double);
        UPDATE_CONFIG_PARAM(elbow_tricep_dynamics_B_1_inflating, double);
        UPDATE_CONFIG_PARAM(elbow_tricep_dynamics_B_0_deflating, double);
        UPDATE_CONFIG_PARAM(elbow_tricep_dynamics_B_1_deflating, double);

#undef UPDATE_CONFIG_PARAM
    ...
    RCLCPP_INFO(
        logger,
        "Control configuration set: %s",
        static_cast<bool>(pm_control_configuration) ? "TRUE" : "FALSE"
    );
    RCLCPP_INFO(
        logger,
        "PM segment configuration size: %zu",
        pm_segment_configurations.size()
    );
    RCLCPP_INFO(
        logger,
        "Using control configuration: '%s'",
        pm_control_configuration->to_string().c_str()
    );
    RCLCPP_INFO(
        logger,
        "Using shoulder PM configuration: '%s'",
        pm_segment_configurations[0].to_string().c_str()
    );
    RCLCPP_INFO(
        logger,
        "Using elbow PM configuration: '%s'",
        pm_segment_configurations[1].to_string().c_str()
    );
    ...
    labelled_joint_trajectory_publisher_ = get_node()->create_publisher<pma_interfaces::msg::LabelledJointTrajectory>(
        "~/labelled_joint_trajectory",
        10
    );
    labelled_pma_robot_trajectory_publisher_ = get_node()->create_publisher<pma_interfaces::msg::LabelledPmaRobotTrajectoryPoint>(
        "~/labelled_pma_robot_trajectory_point",
        10
    );

    //
    // Init state container sizes
    //
...
SlidingMode2DofPressureTrajectoryController::on_activate(const rclcpp_lifecycle::State& /*previous_state*/)
{
    ...
    joint_space_state_current_.effort.clear();
    joint_space_state_desired_ = joint_space_state_current_;

    // TODO(nick): how to reset pressure?
    last_commanded_pma_traj_pt_.joint_space = joint_space_state_current_;
    last_commanded_pma_traj_pt_.time_commanded = get_node()->now();
    ...
    const rclcpp::Duration& period)
{
    ...
    if (current_external_msg != *new_external_msg)
    {
        ...
        traj_external_point_ptr_->update(*new_external_msg);  // TODO(denis): Add here integration of position and velocity
        // @TODO(nick): not RT safe
        pma_interfaces::msg::LabelledJointTrajectory ljt;
        ljt.joint_trajectory = *(traj_external_point_ptr_->get_trajectory_msg().get());
        ljt.motion_number = ++motion_number;
        labelled_joint_trajectory_publisher_->publish(ljt);
    }
    ...
    read_state_from_hardware(joint_space_state_current_);
    {
    ...
    RCLCPP_INFO(
        get_node()->get_logger(),
        "curr state = {p=[%.2lf, %.2lf], v=[%.2lf, %.2lf]}",
        joint_space_state_current_.positions[0],
        joint_space_state_current_.positions[1],
        joint_space_state_current_.velocities[0],
        joint_space_state_current_.velocities[1]
    );
    ...
    if (traj_point_active_ptr_ && (*traj_point_active_ptr_)->has_trajectory_msg())
    {
        ...
        const bool valid_point = (*traj_point_active_ptr_)->sample(
            ...
            joint_space_state_desired_,
            start_segment_itr,
            end_segment_itr
        );
        RCLCPP_INFO(
            get_node()->get_logger(),
            "desi state = {p=[%.2lf, %.2lf], v=[%.2lf, %.2lf]}, valid=%s",
            joint_space_state_desired_.positions[0],
            joint_space_state_desired_.positions[1],
            joint_space_state_desired_.velocities[0],
            joint_space_state_desired_.velocities[1],
            valid_point ? "TRUE" : "FALSE"
        );

        // Transform desired state in joint-space to desired state in
        // pressure-space
        // TODO(nick): not RT safe
        // TODO(nick): package resulting torques
        pma_util::PressureList resulting_pressures;
        Eigen::Vector2d resulting_a_vector{{0.0, 0.0}};
        Eigen::Matrix2d resulting_G_matrix{{0.0, 0.0}, {0.0, 0.0}};
        std::vector<double> resulting_accelerations(dof_, 0.0);
        compute_pma_robot_model(
            *(pm_control_configuration.get()),
            pm_segment_configurations,
            pm_segment_telemetries,
            joint_space_state_desired_.positions,
            joint_space_state_desired_.velocities,
            joint_space_state_current_.positions,
            joint_space_state_current_.velocities,
            resulting_pressures,
            resulting_a_vector,
            resulting_G_matrix,
            resulting_accelerations,
            get_node()
        );
        ...
        if (valid_point)
        {
            ...
            for (size_t index = 0; index < dof_; ++index)
            {
                ...
                joint_space_state_error_.positions[index] = angles::shortest_angular_distance(joint_space_state_current_.positions[index], joint_space_state_desired_.positions[index]);
                joint_space_state_error_.velocities[index] = joint_space_state_desired_.velocities[index] - joint_space_state_current_.velocities[index];
                joint_space_state_error_.accelerations[index] = joint_space_state_desired_.accelerations[index] - joint_space_state_current_.accelerations[index];

                // Always check the state tolerance on the first sample in case the first sample
                // is the last point
                if ((before_last_point || first_sample) && !check_state_tolerance_per_joint(joint_space_state_error_,
                                                                                            index,
                ...
                if (!before_last_point && !check_state_tolerance_per_joint(joint_space_state_error_,
                                                                           index,
            ...
            if (!tolerance_violated_while_moving && within_goal_time)
            {
                for (size_t index = 0; index < dof_; ++index)
                {
                    joint_command_interface_[0][index].get().set_value(resulting_accelerations[index]);
                }
                RCLCPP_INFO(
                    get_node()->get_logger(),
                    "written accelerations = [%.2lf, %.2lf]",
                    resulting_accelerations[0],
                    resulting_accelerations[1]
                );
                last_commanded_pma_traj_pt_.joint_space.positions = joint_space_state_current_.positions;
                last_commanded_pma_traj_pt_.joint_space.velocities = joint_space_state_current_.velocities;
                last_commanded_pma_traj_pt_.joint_space.accelerations = resulting_accelerations;
                last_commanded_pma_traj_pt_.pressures = resulting_pressures;
                last_commanded_pma_traj_pt_.time_commanded = time;

                // @TODO(nick): not RT safe
                pma_interfaces::msg::LabelledPmaRobotTrajectoryPoint lprtj;
                lprtj.motion_number = motion_number;
                lprtj.point = last_commanded_pma_traj_pt_;
                labelled_pma_robot_trajectory_publisher_->publish(lprtj);
            }
            ...
            if (active_goal)
            {
                ...
                feedback->actual = joint_space_state_current_;
                feedback->desired = joint_space_state_desired_;
                feedback->error = joint_space_state_error_;
    ...
    )
    {
        ...
        state_publisher_->msg_.desired = joint_space_state_current_;
        state_publisher_->msg_.actual = joint_space_state_desired_;
        state_publisher_->msg_.error = joint_space_state_error_;
        last_state_publish_time_ = get_node()->now();
...
void SlidingMode2DofPressureTrajectoryController::read_state_from_hardware(JointTrajectoryPtMsg & state)
{
    auto assign_point_from_interface = [&](std::vector<double>& trajectory_point_interface,
    ...
    // Assign all value types from the hardware
